...
__export(index_exports, {
  ...
  useTappyPlugins: () => useTappyPlugins
});
...
var setNode = (typeOrName, attributes = {}) => ({ state, dispatch, chain }) => {
  ...
  return chain().command(({ commands }) => {
    const canSetBlock = (0, import_commands15.setBlockType)(type, __spreadValues(__spreadValues({}, attributesToCopy), attributes))(state);
    if (canSetBlock) {
      return true;
    }
    return commands.clearNodes();
  }).command(({ state: updatedState }) => {
    return (0, import_commands15.setBlockType)(type, __spreadValues(__spreadValues({}, attributesToCopy), attributes))(updatedState, dispatch);
  }).run();
};
...
var PreviewCard = ({ url, metadata }) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    "a",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex flex-col sm:flex-row border border-gray-200 dark:border-gray-800 rounded-xl overflow-hidden hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors duration-200 my-4 max-w-2xl bg-white dark:bg-black/40", children: [
        image && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "w-full sm:w-48 h-48 sm:h-auto flex-shrink-0 bg-gray-100 dark:bg-gray-800 relative", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "img",
          {
            src: image,
        ...
        /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "p-4 flex flex-col justify-center flex-grow overflow-hidden", children: [
          site_name && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "text-xs font-semibold text-gray-500 dark:text-gray-400 mb-1 uppercase tracking-wider", children: site_name }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsx)("h3", { className: "text-base sm:text-lg font-medium text-gray-900 dark:text-gray-100 line-clamp-2 mb-1", children: title || url }),
          description && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", { className: "text-sm text-gray-500 dark:text-gray-400 line-clamp-2 mb-3", children: description }),
          /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: "flex items-center text-xs text-blue-500 font-medium mt-auto break-all", children: [
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)(import_lucide_react.ExternalLink, { className: "w-3 h-3 mr-1 flex-shrink-0" }),
            /* @__PURE__ */ (0, import_jsx_runtime.jsx)("span", { className: "truncate", children: url })
          ] })
        ] })
      ] })
    }
...
var EmbedWrapper = (props) => {
  ...
  const [isIframeLoading, setIsIframeLoading] = (0, import_react2.useState)(true);
  if (isLoading) {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react.NodeViewWrapper, { className: "my-6", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "w-full flex items-center p-4 bg-gray-50 dark:bg-gray-800/50 rounded-xl border border-gray-200 dark:border-gray-800", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react2.Loader2, { className: "w-5 h-5 text-blue-500 animate-spin mr-3" }),
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "text-sm text-gray-500 dark:text-gray-400", children: [
        "Loading embed for ",
        originalUrl,
        "..."
      ] })
  ...
  if (embedType === "error") {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react.NodeViewWrapper, { className: "my-6", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "w-full flex items-center justify-between p-4 bg-red-50 dark:bg-red-900/20 text-red-600 dark:text-red-400 rounded-xl border border-red-200 dark:border-red-900/30", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react2.Link2, { className: "w-5 h-5 mr-3" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "text-sm font-medium", children: [
          "Failed to load embed: ",
          originalUrl
        ] })
      ] }),
      selected && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("button", { onClick: deleteNode2, className: "p-1 hover:bg-red-100 dark:hover:bg-red-900/50 rounded transition-colors", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react2.Trash2, { className: "w-4 h-4" }) })
    ] }) });
  }
  if (embedType === "card") {
    return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(import_react.NodeViewWrapper, { className: "relative group", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(PreviewCard, { url: originalUrl, metadata }),
      selected && /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "absolute top-2 right-2 z-20 flex gap-2", children: /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
        "button",
        {
          onClick: deleteNode2,
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(
    import_react.NodeViewWrapper,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: cn("w-full h-full relative bg-gray-100 dark:bg-gray-800", aspectRatioClass), children: [
        isIframeLoading && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "absolute inset-0 flex flex-col items-center justify-center bg-gray-100/80 dark:bg-gray-800/80 backdrop-blur-sm z-10 animate-pulse", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_lucide_react2.Loader2, { className: "w-8 h-8 text-blue-500 animate-spin mb-2" }),
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "text-sm text-gray-500 dark:text-gray-400 font-medium", children: "Loading iframe..." })
        ] }),
...
var SmartEmbed = Node3.create({
  ...
  addNodeView() {
    return (0, import_react3.ReactNodeViewRenderer)(EmbedWrapper);
  },
  addCommands() {
    return {
  ...
  addProseMirrorPlugins() {
    ...
    return [
      new import_state26.Plugin({
        key: new import_state26.PluginKey("smartEmbedPaste"),
        props: {
  ...
  const items = [
    {
      ...
      icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react3.Type, { className: "w-4 h-4" }),
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react3.Heading1, { className: "w-4 h-4" }),
      command: ({ editor, range }) => {
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react3.Heading2, { className: "w-4 h-4" }),
      command: ({ editor, range }) => {
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react3.Heading3, { className: "w-4 h-4" }),
      command: ({ editor, range }) => {
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react3.Code, { className: "w-4 h-4" }),
      command: ({ editor, range }) => {
    ...
    },
    {
      ...
      icon: /* @__PURE__ */ (0, import_jsx_runtime3.jsx)(import_lucide_react3.Video, { className: "w-4 h-4" }),
      command: ({ editor, range }) => {
...
var CommandPalette = (0, import_react4.forwardRef)((props, ref) => {
  ...
  (0, import_react4.useEffect)(() => setSelectedIndex(0), [props.items]);
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "bg-white dark:bg-gray-900 border border-gray-200 dark:border-gray-800 shadow-xl rounded-xl overflow-hidden min-w-[280px] p-2 flex flex-col gap-1", children: props.items.map((item, index) => /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)(
    "button",
    {
      ...
      children: [
        /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: `p-2 rounded-md ${index === selectedIndex ? "bg-white dark:bg-gray-800 shadow-sm" : "bg-gray-100 dark:bg-gray-800"}`, children: item.icon }),
        /* @__PURE__ */ (0, import_jsx_runtime3.jsxs)("div", { children: [
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: "font-medium text-sm", children: item.title }),
          /* @__PURE__ */ (0, import_jsx_runtime3.jsx)("div", { className: `text-xs ${index === selectedIndex ? "text-blue-500/70 dark:text-blue-400/70" : "text-gray-500"}`, children: item.description })
        ] })
      ]
    },
    index
    ...
    return [
      (0, import_suggestion.default)(__spreadProps(__spreadValues({
        ...
        render: () => {
          ...
          return {
            onStart: (props) => {
              component = new import_react5.ReactRenderer(CommandPalette, {
                props,
                editor: props.editor
              });
              if (!props.clientRect) {
...
var defaultExtensions = [
  ...
  import_extension_character_count.default.configure({ limit: 300 }),
  SmartEmbed,
  SlashCommand
];
...
function useTappyPlugins() {
  const [plugins, setPlugins] = (0, import_react6.useState)([]);
  const [extensions, setExtensions] = (0, import_react6.useState)([]);
...
var TappyEditor = (0, import_react8.forwardRef)(
  ({ value = "", onChange, className, readOnly = false }, ref) => {
    ...
    const [characterCount, setCharacterCount] = (0, import_react8.useState)(0);
      ...
      "div",
      {
        ...
        children: /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(
          "div",
          {
            ...
            children: [
              /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(import_react7.EditorContent, { editor, className: "h-full" }),
              /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)("div", { className: "absolute bottom-4 right-4 flex items-center gap-2 text-xs text-gray-700 dark:text-gray-300 font-medium bg-white/30 dark:bg-black/30 backdrop-blur-md px-2 py-1 rounded-full border border-white/20 dark:border-white/10 shadow-sm", children: [
...
function usePersistence({ editor, key = "tappy-editor-content" }) {
  const saveContent = (0, import_react9.useCallback)(() => {
  ...
  const loadContent = (0, import_react9.useCallback)((data) => {
  ...
  const exportHTML = (0, import_react9.useCallback)(() => {
    if (!editor) return "";
