...
var EmbedWrapper = (props) => {
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
    import_react.NodeViewWrapper,
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { className: cn("w-full h-full relative bg-gray-100 dark:bg-gray-800", aspectRatioClass), children: [
        ...
        selected && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { className: "absolute top-2 right-2 z-10 flex gap-2", children: /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
          "button",
          {
            onClick: deleteNode2,
...
var VideoEmbed = Node3.create({
  ...
  addNodeView() {
    return (0, import_react2.ReactNodeViewRenderer)(EmbedWrapper);
  },
  addCommands() {
    return {
...
var TappyEditor = ({
  ...
  const [characterCount, setCharacterCount] = (0, import_react4.useState)(0);
    ...
    "div",
    {
      ...
      children: /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
        "div",
        {
          ...
          children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)(import_react3.EditorContent, { editor, className: "h-full" }),
            /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "absolute bottom-4 right-4 flex items-center gap-2 text-xs text-gray-700 dark:text-gray-300 font-medium bg-white/30 dark:bg-black/30 backdrop-blur-md px-2 py-1 rounded-full border border-white/20 dark:border-white/10 shadow-sm", children: [
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { children: [
                characterCount,
                " / ",
                characterLimit
              ] }),
              /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("svg", { width: "24", height: "24", viewBox: "0 0 24 24", className: "-rotate-90", children: [
